...
Finally, highlight role in diffusion models - Stein Score distillation - \url{https://arxiv.org/abs/2401.00604}. Also CDF estimation (Boris Kramer) - \url{https://arxiv.org/abs/2303.06422}
...
\end{align}
Here, $\nabla_x \log p(x)$ is the gradient of the log probability density of the target distribution. This is also referred to as the \emph{score function} or simply the score in generative modeling literature, a term we adopt for the remainder of this text. The use of the score is particularly beneficial for applications such as Bayesian inference where the difficulty in computation of the normalizing constant can be sidestepped.
