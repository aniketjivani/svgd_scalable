...
\begin{enumerate}
    ...
    \textcolor{blue}{The simplest thing we can actually try, funnily enough, is just replacing $p(.)$ by some MLP and / or a richer kernel representation for $k$ - the point being that we can get rid of the variational family and consider a more general case.}
...
(doing what's already been done before and probably isn't very remarkable once I think about it a little more, unless I am very mistaken) Connecting trace and Stein operator from Liu's paper...
