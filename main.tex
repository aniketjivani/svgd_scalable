...
Next, we plot the KL divergence as a function of the number of particles between the SVGD particles at the final update step and samples from the true posterior. 
We overlay the KL divergence trend for the bifidelity case too, with each additional line plot representing the magnitude of the correction function.
