...
\subsection{OT-based Flow Matching}

The generative modeling approach proposed in \cite{tong_improving_2024} generalizes the flow matching framework proposed by \cite{lipman_flow_2023} to use arbitrary transport maps and approximate dynamic Optimal Transport to improve the efficiency of training and inference. Below, we briefly review OT-based conditional flow matching algorithms and motivate their use in learning maps between samples from multiple-fidelity model likelihoods.
