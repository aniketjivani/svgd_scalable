...
The most general form of a multi-fidelity update for SVGD would partition the incremental transform in the style of ACVs so that particles are allocated to target-densities of different fidelities for computing the incremental transform at every iteration. 
...
Following the notation of \autoref{ss: acv}, we obtain:
